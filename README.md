...
12. When user will tap of blank ```myMethodToHandleTap``` will invoked. Here Identify the ```NSRange``` of tapped attributed, open Sheet with shuffled words of set already removed words.
